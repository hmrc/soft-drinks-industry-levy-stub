...
sealed trait Activity {
  ...
  def isNotProducerCopackerImporter: Boolean = !isProducer && isLarge && isContractPacker && isImporter
  def isSmallProducerCopackerImporter: Boolean = isProducer && !isLarge && isContractPacker && isImporter
}
