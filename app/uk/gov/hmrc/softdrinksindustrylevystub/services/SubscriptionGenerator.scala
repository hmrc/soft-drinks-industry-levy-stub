...
object SubscriptionGenerator {
  ...
  private val testDataOverrides: Map[String, InternalActivity] = {
    val entries = Seq(
      "5168983848" -> createActivity(
